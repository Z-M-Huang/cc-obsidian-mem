...
| File                                | Field                | Example              |
| ----------------------------------- | -------------------- | -------------------- |
| `plugin/package.json`               | `version`            | `"version": "0.5.5"` |
| `plugin/.claude-plugin/plugin.json` | `version`            | `"version": "0.5.5"` |
| `.claude-plugin/marketplace.json`   | `plugins[0].version` | `"version": "0.5.5"` |
| `plugin/src/mcp-server/index.ts`    | `version`            | `version: "0.5.5"`   |
